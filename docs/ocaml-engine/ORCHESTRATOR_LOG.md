...
| 2026-07-06T22:40:00Z | PORT | M0 harness + runner: pcre2test-compatible harness (functor over DRIVER; full 140-entry modlist; process_data escape decoder; global-loop with NOTEMPTY_ATSTART retry + CRLF/UTF bump; copy/get/getall; MK:/partial/aftertext/allcaptures) + conformance runner (unit splitter/aligner, skiplist w/ STALE-SKIP, baselines, --frontier/--only) | — → testinput2:1305 | pending | testinput1 1290/1290 BYTE-IDENTICAL vs oracle; sweep: t4 617/617, t5 418P/0F/206S, t2 729P/12F/1102S; 12 failures diagnosed: 7 callout units, 4 MARK-with-NUL (driver strlen bug), 1 RunTest -error artifact |
