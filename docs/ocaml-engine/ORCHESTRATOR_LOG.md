...
| 2026-07-06T23:25:00Z | PORT | M0 CI: build-pure (opam, no libpcre2, OCaml 4.14/5.2 matrix) + conformance (nix: @all, @gen-check, runtest, runner vs baselines) | none failing → none failing | pending | fuzz smoke + bench gate steps stubbed as comments until those components land; M0 COMPLETE |
